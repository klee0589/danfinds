    ...
    <div className="min-h-screen bg-background dark:bg-gray-900">
      ...
      <div className="w-full h-64 md:h-96 overflow-hidden bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
        {post.products?.[0]?.image
          ? <img src={getOptimizedImageUrl(post.products[0].image, 900)} alt={post.title} className="w-full h-full object-cover" fetchpriority="high" width="900" height="384" referrerPolicy="no-referrer" />
